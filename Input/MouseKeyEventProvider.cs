...
/// events.
/// </summary>
public class MouseKeyEventProvider : System.ComponentModel.Component
{
    #region Properties

    private readonly ListenerKeyboard keyboardHookManager;
    private readonly ListenerMouse mouseHookManager;
    ...
    private event EventHandler<MouseEventExtArgs> mouseClickExt;
    /// <summary>
    /// Activated upon a single click of the mouse.
    /// </summary>
    /// <remarks>
...
#pragma warning restore 618
    ...
    private event EventHandler<MouseEventExtArgs> mouseDownExt;
    /// <summary>
    /// Activated when the user presses a mouse button.
    /// </summary>
    /// <remarks>
    ...
    private event EventHandler<MouseEventExtArgs> mouseMoveExt;
    /// <summary>
    /// Activated when the user moves the mouse. 
    /// </summary>
    /// <remarks>
    ...
    private event EventHandler<MouseEventArgs> mouseWheel;
    /// <summary>
    ...
    private event MouseEventHandler mouseUp;
    /// <summary>
    ...
    {
        keyboardHookManager = new ListenerKeyboard(new GlobalHooker());
        mouseHookManager = new ListenerMouse(new GlobalHooker());
    }
    ...
    private void RaiseEventOnUIThread(Delegate inputEvent, EventArgs e)
    {
        ...
        {
            if (d.Target is not ISynchronizeInvoke syncer)
            {
            ...
            else
            {
                ...
                syncer.Invoke(inputEvent, [sender, e]);
            }
        }
    }
