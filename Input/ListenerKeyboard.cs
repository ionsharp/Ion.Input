...
/// </summary>
/// <remarks>
/// Initializes a new instance of <see cref="ListenerKeyboard"/>.
/// </remarks>
...
public class ListenerKeyboard(Hooker hooker) : ListenerBase(hooker)
{
    ...
    private void InvokeKeyDown(KeyEventArgsExt e)
    {
        ...
        if (handler is null || e.Handled || !e.IsKeyDown) { return; }
        handler(this, e);
    }
    ...
    private void InvokeKeyPress(KeyPressEventArgsExt e)
    {
        ...
        if (handler is null || e.Handled || e.IsNonChar) { return; }
        handler(this, e);
    }
    ...
    private void InvokeKeyUp(KeyEventArgsExt e)
    {
        ...
        if (handler is null || e.Handled || !e.IsKeyUp) { return; }
        handler(this, e);
    }
