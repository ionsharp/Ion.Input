...
public class MouseEventExtArgs : MouseEventArgs
{
    ...
    internal MouseEventExtArgs(MouseButtons buttons, int clicks, WinApi.Point point, int delta, int timestamp, bool isMouseKeyDown, bool isMouseKeyUp)
