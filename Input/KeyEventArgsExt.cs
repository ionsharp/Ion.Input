...
/// <summary>
/// Provides extended argument data for the <see cref='ListenerKeyboard.KeyDown'/> or <see cref='ListenerKeyboard.KeyUp'/> event.
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="KeyEventArgsExt"/> class.
/// </remarks>
/// <param name="keyData"></param>
public class KeyEventArgsExt(Keys keyData) : KeyEventArgs(keyData)
{
